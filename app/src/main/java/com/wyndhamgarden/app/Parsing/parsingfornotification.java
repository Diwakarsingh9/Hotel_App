...
import com.wyndhamgarden.app.settergetter.settergetterpush;
...
public class parsingfornotification {
    ...
    public static void parsing(final Context activity, String s1, String imei){


        String locationurl2 = "http://wyndhamgardengrantham.co.uk/api/add_did.php?did="+s1+"&flag=2";
        //String locationurl2 = ApplicationConstants.APP_SERVER_URL.concat(s1).concat("&udid=wyndham&flag=2");
